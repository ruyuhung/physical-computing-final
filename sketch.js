...
function draw() {
    ...
    var diameter = random(30,100)*frameCount*0.001;
    var r = random(150, 200);
    var b = random(100, 190)*frameCount*0.001;
    noStroke();
    fill(r, 0, b);
...
function parseData(data)
{
  ...
  radius = map(reading, 0, 4046, 1, 500); // map the audio envolope input to the size of 1/4*canvas
}
